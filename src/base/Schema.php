...
namespace barrelstrength\sproutsitemaps\base;

use barrelstrength\sproutsitemaps\helpers\OptimizeHelper;
use barrelstrength\sproutsitemaps\schema\ContactPointSchema;
use barrelstrength\sproutsitemaps\schema\GeoSchema;
use barrelstrength\sproutsitemaps\schema\ImageObjectSchema;
use barrelstrength\sproutsitemaps\schema\MainEntityOfPageSchema;
use barrelstrength\sproutsitemaps\schema\PostalAddressSchema;
use barrelstrength\sproutsitemaps\models\Globals;
use barrelstrength\sproutsitemaps\models\Metadata;
...
'.$output.'
    ...
    public function addUrl($propertyName, $url)
    {
        if (!filter_var($url, FILTER_VALIDATE_URL) === false) {
            ...
            SproutSitemaps::info('Schema unable to add value. Value is not a valid URL.');
        }
    }
    ...
    public function addTelephone($propertyName, $phone)
    {
        if (isset($phone['phone']) && isset($phone['country']) && !empty($phone['phone'])) {
            ...
            SproutSitemaps::info('Schema unable to add value. Value is not a valid Phone.');
        }
    }
    ...
    public function addEmail($propertyName, $email)
    {
        if (!filter_var($email, FILTER_VALIDATE_EMAIL) === false) {
            ...
            SproutSitemaps::info('Schema unable to add value. Value is not a valid Email.');
        }
    }
