...
use craft\db\Query;
use Craft;
use barrelstrength\sproutsitemaps\records\SitemapSection as SitemapSectionRecord;
    ...
    public function saveSitemapSection(SitemapSection $sitemapSection): bool
    {
        ...
        if (!$isNewSection) {
            if (null === ($sitemapSectionRecord = SitemapSectionRecord::findOne($sitemapSection->id))) {
                throw new Exception(Craft::t('sprout-sitemaps', 'Unable to find Sitemap with ID "{id}"', [
