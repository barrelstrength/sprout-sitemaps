...
class SitemapsController extends Controller
{
    ...
    public function actionSitemapEditTemplate(int $sitemapSectionId = null, string $siteHandle = null, SitemapSection $sitemapSection = null)
    {
        ...
        $continueEditingUrl = 'sprout-sitemaps/sitemaps/edit/{id}/'.$currentSite->handle;
    ...
    public function actionSaveSitemapSection()
    {
        ...
        if (!SproutSitemaps::$app->sitemaps->saveSitemapSection($sitemapSection)) {
            ...
            Craft::$app->getSession()->setError(Craft::t('sprout-sitemaps', "Couldn't save the Sitemap."));
        ...
        Craft::$app->getSession()->setNotice(Craft::t('sprout-sitemaps', 'Sitemap saved.'));
